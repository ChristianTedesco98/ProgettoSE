...
function initBrowsing() {
    ...
    $.getJSON("http://"+JAVA_TOMCAT_HOST+ "/MaintenanceProject/Planner/jsp/visualize_activities.jsp",{week: myParam}, function (data) {
        renderGui(data);
    }).fail(function () {
...
function renderGui(data) {
    ...
    $.each(data, function (index, obj) {
        ...
        let buttons = '<a href="visualize_selected.html?id='+obj.id_activity+'&week='+myParam+'&area='+obj.area+'&type='+obj.type+'&eit='+obj.eit+'"><button type="button" class="btn btn-dark" style="height:40px; width: 150px; font-size: 20px; text-align: center;"><b>Select</b></button></a>'
